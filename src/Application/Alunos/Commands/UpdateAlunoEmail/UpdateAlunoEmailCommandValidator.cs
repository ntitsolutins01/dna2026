...
public class UpdateAlunoEmailCommandValidator : AbstractValidator<UpdateAlunoEmailCommand>
{
    private readonly IApplicationDbContext _context;

    public UpdateAlunoEmailCommandValidator(IApplicationDbContext context)
    {
        _context = context;
