...
public record UpdateEducacionalCommand : IRequest<bool>
{
...
public class UpdateEducacionalCommandHandler : IRequestHandler<UpdateEducacionalCommand, bool>
{
    private readonly IApplicationDbContext _context;

    public UpdateEducacionalCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<bool> Handle(UpdateEducacionalCommand request, CancellationToken cancellationToken)
    {
        var entity = await _context.Educacionais
