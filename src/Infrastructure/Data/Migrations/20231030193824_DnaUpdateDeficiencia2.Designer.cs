...
namespace DnaBrasilApi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20231030193824_DnaUpdateDeficiencia2")]
    partial class DnaUpdateDeficiencia2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContratosLocais", b =>
                {
                    b.Property<int>("ContratoId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ContratoId", "LocalId");

                    b.HasIndex("LocalId");

                    b.ToTable("ContratosLocais");
                });
            ...
            modelBuilder.Entity("ContratosLocais", b =>
                {
                    ...
                    b.HasOne("DnaBrasilApi.Domain.Entities.Local", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DnaBrasilApi.Domain.Entities.Aluno", b =>
                {
                    b.HasOne("DnaBrasilApi.Domain.Entities.Matricula", "Matricula")
                        .WithMany()
                    ...
                    b.HasOne("DnaBrasilApi.Domain.Entities.Voucher", "Voucher")
                        .WithMany()
            ...
            modelBuilder.Entity("DnaBrasilApi.Domain.Entities.Questionario", b =>
                {
                    b.HasOne("DnaBrasilApi.Domain.Entities.ConsumoAlimentar", null)
                        .WithMany("Questionarios")
                        .HasForeignKey("ConsumoAlimentarId");

                    b.HasOne("DnaBrasilApi.Domain.Entities.QualidadeDeVida", null)
                        .WithMany("Questionarios")
                        .HasForeignKey("QualidadeDeVidaId");

                    b.HasOne("DnaBrasilApi.Domain.Entities.SaudeBucal", null)
                        .WithMany("Questionarios")
                        .HasForeignKey("SaudeBucalId");

                    b.HasOne("DnaBrasilApi.Domain.Entities.TipoLaudo", "Tipo")
                        .WithMany()
                        .HasForeignKey("TipoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DnaBrasilApi.Domain.Entities.Vocacional", null)
                        .WithMany("Questionarios")
